...
class ComplimentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compliment" do
    assert_difference('Compliment.count') do
      post compliments_url, params: { compliment: { content: @compliment.content } }, as: :json
    end
  ...
  test "should update compliment" do
    patch compliment_url(@compliment), params: { compliment: { content: @compliment.content } }, as: :json
    assert_response 200
  end
